...
<!-- ==================== 3D FLYING POSTERS HERO SECTION ==================== -->
  ...
  loadOGL(() => {
    ...
    class CanvasEngine {
      constructor() {
        ...
        this.items = items;
        this.planeWidth = 360;
        this.planeHeight = 360;
        this.distortion = 3;
        this.scroll = { ease: 0.04, current: 0, target: 0, last: 0 };
        this.cameraFov = 45;
        this.cameraZ = 20;
      ...
      onResize() {
        ...
        this.screen = { width: rect.width || window.innerWidth, height: rect.height || window.innerHeight };
      ...
      onTouchMove(e) {
        ...
        const distance = (this.start - y) * 0.08;
